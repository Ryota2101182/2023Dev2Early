...
<?php require_once 'header.php'?>
	<section class="wrapper">
    	<div class="container">
        	<div class="content">
				...
				<div class="list">
                	<div class="list-item">
                    	<div class="text">フォロー：１２</div>
                	</div>
                	<div class="list-item">
                    	<div class="text">フォロワー：３０</div>
                	</div>    
            	</div>
                <div style="border: 2px solid #333333; border-radius: 5px; width:250px; margin:0 auto;">
                    <p class="follow">フォロー中</p>
                </div>
        	</div>
    	</div>
	</section>
    <section>
        <div class="content2 col-12">
		    <h2 class="title">(5/18)AKIEDA セットアップ</h2>
		    <p class="text">
		        夏に向けてセットアップコーデを組んでみました
		    </p>
		<div class="text-center">
			<img src="img/BLOG/akiedablog.jpg" alt="" width="400" height="500">
		</div>
		<div class="text-left">
			<a href="blog1.php"><p>read more</p></a>
		</div>
	  </div>
    </section>
    <section>
