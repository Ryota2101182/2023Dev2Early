...
INSERT INTO `buys` (`buy_id`, `user_id`, `item_id`, `buy_itemsize`, `buy_sum`, `buy_date`) VALUES
(69, 27, 19, 'S', 3, '2022-12-20'),
(70, 27, 19, 'M', 3, '2022-12-20'),
(71, 27, 1, 'S', 3, '2022-12-20'),
(72, 27, 1, 'M', 3, '2022-12-20');
...
INSERT INTO `user` (`user_id`, `user_familyname`, `user_firstname`, `user_address`, `user_mail`, `user_password`) VALUES
(27, 'aaa', 'aaa', 'aaaaa', 'test@s.asojuku.ac.jp', '$2y$10$eVQjzanSJ5tBUBNCMDiJPO4Ax.5NVSHVHcPrDuZQurCwA00jSxFP.');
...
--
ALTER TABLE `buys`
  MODIFY `buy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
